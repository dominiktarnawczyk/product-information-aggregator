...
import com.mocks.pricing.config.PricingInterceptorProperties
...
class PricingInterceptorUnitTest {

    private lateinit var interceptor: PricingInterceptor
    private lateinit var properties: PricingInterceptorProperties
    ...
    @BeforeEach
    fun setUp() {
        properties = PricingInterceptorProperties()
        interceptor = PricingInterceptor(properties)
